...
appsody-sample-microprofile   appsody-sample-microprofile-kabanero-samples.ocp.example.com            appsody-sample-microprofile   8080                    None
----
...
kind: AppsodyApplication
metadata:
  name: appsody-sample-smircroprofile
  namespace: kabanero-samples
spec:
...
appsody-sample-smircroprofile   http://appsody-sample-smircroprofile.kabanero-samples.ocp.example.com  appsody-sample-smircroprofile-mtl4q   appsody-sample-smircroprofile-mtl4q   True
----
...
appsody-sample-smircroprofile   appsody-sample-smircroprofile-mtl4q   appsody-sample-smircroprofile-mtl4q   True
----

- Show the Knative latest ready revision
[source, bash]
----
oc get revision.serving.knative.dev/appsody-sample-smircroprofile-mtl4q

NAME                                  SERVICE NAME                          GENERATION   READY     REASON
appsody-sample-smircroprofile-mtl4q   appsody-sample-smircroprofile-mtl4q   2            True
----
...
appsody-sample-smircroprofile-mtl4q-deployment-7bf6dbddf6-rr89p   2/2       Running   0          27s
----
