...
Running docker command: docker[run --rm -p 35729:35729 -p 5005:5005 -p 8080:8080 --name appsody-sample-springboot-dev -u 501:20 -e APPSODY_USER=501 -e APPSODY_GROUP=20 -v /Users/Hemankita.Perabathini@ibm.com/codewind-workspace/appsody-sample-springboot/.:/project/user-app -v /Users/Hemankita.Perabathini@ibm.com/.m2/repository:/mvn/repository -v /Users/Hemankita.Perabathini@ibm.com/.appsody/appsody-controller:/appsody/appsody-controller -t --entrypoint /appsody/appsody-controller kabanero/java-spring-boot2:0.3 --mode=test]
