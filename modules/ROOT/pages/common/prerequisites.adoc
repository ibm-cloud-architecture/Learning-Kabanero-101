...
** Install Cloud Pak for Application 4.x on RedHat OpenShift 4.x using https://www.ibm.com/support/knowledgecenter/en/SSCSJL_4.1.x/install-icpa-cli.html[CLI Installer for OCP4^]
