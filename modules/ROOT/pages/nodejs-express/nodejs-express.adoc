...
You can now acccess the application at <HOST/PORT>, here it is `appsody-sample-nodejs-express-kabanero-samples.csantana-ocp3-fa9ee67c9ab6a7791435450358e564cc-0001.us-east.containers.appdomain.cloud`.
...
Git push the change, tekton pipeline runs, show the app again running and inspect extra resource associated with Knative
