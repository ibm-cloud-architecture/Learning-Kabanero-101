...
image::stack-appsody-list.png[align="center"]
...
A new instance of the application will start in a docker container and you can see your updated applcation code by navigating to http://localhost:9080/test in your web browser


image::appsody-running.png[align="center"]